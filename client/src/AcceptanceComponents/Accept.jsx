  ...
  return (
    <div>
        <div className='h-[350px] gap-3 p-2 lg:p-2 mb-5 lg:mb-14 mt-3 grid md:grid-cols-2 lg:grid-cols-2'>
          <section className='rounded-lg border-blue-500 border-2'>
            <h1 className='font-bold text-3xl pt-3 ml-3'>OUR ACCEPTANCE PAYMENT PAGE</h1>
          </section>
          <section className=''>
        ...
        <div className=' h-[300px] mb-[620px] md:mb-[265px] lg:mb-5 p-3 gap-4 ml-3 mr-3 mt-2 md:mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
          <section className='bg-white border-blue-400 border-2 hover:bg-blue-300 hover:-mt-3 transition-all duration-700  rounded-lg '>
            ...
            <h1 className='font-bold text-center text-2xl mt-12 md:mt-14'>Online Automatic Payments</h1>
          </section>
          <section className='bg-white border-blue-400 border-2 hover:bg-blue-300 hover:-mt-3 transition-all duration-700   rounded-lg'>
          ...
          <section className='bg-white border-blue-400 border-2 hover:bg-blue-300 hover:-mt-3 transition-all duration-700   rounded-lg'>
            ...
            <h1 className='font-bold text-center text-2xl mt-10 md:mt-20'>Phone Automatic Payments</h1>
          </section>
        </div>

        <main className='mt-2 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[70%,30%] lg:gap-4'>
          <section className=''>
            <h1 className='lg:pt-16 pt-8 ml-5 md:ml-8 font-bold text-3xl md:text-5xl'>CREDIT Q&A</h1>
            <div className='h-[80px] bg-blue-200 mr-4 ml-3 mt-8'>
              <h1 className='font-semibold md:font-bold text-blue-600 pt-5 text-xl md:text-2xl ml-4 mb-5'onClick={()=> move =="0px" ? setMove('120px') : setMove("0px")}>CAN I GET A CREDIT ON LOAN?<span className='text-3xl ml-4 md:ml-[320px] lg:ml-[550px] lg:text-4xl'onClick={()=> move =="0px" ? setMove('120px') : setMove("0px")}>+</span></h1>
            </div>
            ...
            <div className='h-[80px] bg-blue-200 mr-4 ml-3 mt-8'>
              <h1 className='font-semibold text-blue-600 md:font-bold text-xl md:text-2xl lg:text-2xl ml-3 md:ml-4 md:pt-5 mb-5'onClick={()=> mover =="0px" ? setMover('125px') : setMover("0px")}>HOW IS MY INTEREST RATE DETERMINED?<span className='text-3xl ml-44 md:ml-[180px] lg:ml-[420px] lg:text-4xl'onClick={()=> mover =="0px" ? setMover('125px') : setMover("0px")}>+</span></h1>
            </div>
            ...
            <div className='md:h-[80px] h-[65x] bg-blue-200 mr-4 ml-3 mt-10'>
              <h1 className=' text-blue-600 md:font-bold text-xl md:text-xl lg:text-2xl ml-3 md:ml-4 md:pt-5 mb-5'onClick={()=> moves =="0px" ? setMoves('120px') : setMoves("0px")}>CAN I APPLY FOR A LOAN WITH A CO-SIGNER?<span className='text-3xl ml-[200px] md:ml-[230px] lg:ml-[375px] lg:text-4xl'onClick={()=> moves =="0px" ? setMoves('120px') : setMoves("0px")}>+</span></h1>
            </div>
            ...
            <div className='h-[80px] md:h-[70px] lg:h-[80px] bg-blue-200 mr-4 ml-3 mt-8'>
              <h1 className='font-semibold text-blue-600 md:font-bold text-xl md:text-xl lg:text-2xl ml-3 md:ml-4 md:pt-5 mb-5'onClick={()=> movest =="0px" ? setMovest('120px') : setMovest("0px")}>HOW DOES MY CREDIT SCORES AFFECT MY LOAN OPTIONS?<span className='text-3xl ml-10 md:ml-[80px] lg:ml-[190px] lg:text-4xl'onClick={()=> movest =="0px" ? setMovest('120px') : setMovest("0px")}>+</span></h1>
            </div>
